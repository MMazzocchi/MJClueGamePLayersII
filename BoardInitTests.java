...
public class BoardInitTests {
	...
	{
		int numDoors = 0;
		int totalCells = (board.getNumCols() + 1) * (board.getNumRows() + 1);
	...
	public void testCalcIndex() {
		...
		assertEquals(NUM_COLUMNS, board.calcIndex(0, NUM_COLUMNS));
		assertEquals(483, board.calcIndex(NUM_ROWS, 0));
		assertEquals(505, board.calcIndex(NUM_ROWS, NUM_COLUMNS));
